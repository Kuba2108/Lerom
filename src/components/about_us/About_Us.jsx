...
import SvgStrel from "../../assets/svg/SvgStrel.jsx";
import VectorTwo from "../../assets/svg/VectorTwo.jsx";
import SvgStrelTwo from "../../assets/svg/SvgStrelTwo.jsx";
                ...
                <div className="flex justify-center pl-[70px] ">
                    ...
                    <div className="ml-[31px]">
                        ...
                        <div className="flex gap-3 items-center mt-[99px]">
                            <button className="py-[20px] px-[20px] bg-white border-blue-900 border rounded-[50%] ">
                                <SvgStrelTwo/>
                            </button>
