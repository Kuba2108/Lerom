    ...
    <div>
      <div className="flex">
        ...
        <div className="ml-[40px] text-slate-900 mt-[54px]">
          ...
          <button className="border-blue-950 border-[1px] rounded-full p-4 mt-6"><img src={ArrowLeft} alt="" /></button>
        </div>
      ...
      <div className="ml-[40px] text-slate-900 mt-[54px]">
          ...
          <p className="text-slate-900 text-xl mt-5">Цены от: 42.000р</p>
          <button className="border-blue-950 border-[1px] rounded-full p-4 mt-6"><img src={ArrowRight} alt="" /></button>
        </div>
